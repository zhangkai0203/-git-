...
$savePath = "/home/wwwroot/demo/";
$gitPath  = "https://gitee.com/zhangsan0203/shop.xiaokang100.com.git";//代码仓库
$email = "zhangkai020305@163.com";//用户仓库邮箱
$name  = "zhangkai020305@163.com";//仓库用户名,一般和邮箱一致即可

$isClone = true;//设置是否已经Clone到本地,true:已经clone,直接pull,false:先clone.

$res = shell_exec("cd /home/wwwroot/demo/ && git stash && git pull");
var_dump($res);
...
if ($isClone) {
    ...
    if ($content['ref']=='refs/heads/master' && $content['total_commits_count']>0) {
        ...
        $res .= shell_exec("cd {$savePath} && git pull");//拉去代码
        $res_log = '-------------------------'.PHP_EOL;
